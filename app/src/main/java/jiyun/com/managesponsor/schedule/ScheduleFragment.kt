...
class ScheduleFragment : Fragment(), ScheduleNavigator {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding.viewModel = ScheduleViewModel(this)
            ...
            adapter = ScheduleAdapter().apply {
                ...
                disposables.add(
                        clickSubject.subscribe {
                            ScheduleDetailFragment().show(activity?.supportFragmentManager, "preview")
                        }
                )
            }
        }
    ...
    override fun getSupportFragmentManager(): FragmentManager = activity?.supportFragmentManager
            ?: throw  NullPointerException("Support manager is null")
